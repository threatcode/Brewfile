...
######################################################################
# 🍺 ThreatCode/Brewfile - All-in-one install script                 #
######################################################################
...
REMOTE_BREWFILE="https://raw.githubusercontent.com/ThreatCode/Brewfile/HEAD/Brewfile"
...
show_intro () {
  echo -e "\n${QUESTION_COLOR}🍺 ThreatCode/Brewfile - Installation Script${RESET}"
...
echo -e "\033[0;33m\x1b[2mThank you for using ThreatCode/Brewfile${RESET}"
